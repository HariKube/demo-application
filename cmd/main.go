...
import (
	...
	"example.com/my-project/internal/apiserver"
	"example.com/my-project/internal/controller"
	webhookv1 "example.com/my-project/internal/webhook/v1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "11b0b359.example.com",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err := webhookv1.SetupReportWebhookWithManager(mgr); err != nil {
	...
	if err := mgr.Add(apiserver.New(apiServerPort, apiServerCertFile, apiServerKeyFile)); err != nil {
